...
## Kako se dodaje nov stan

1. U `stanovi.json` kopiraj ceo blok jednog stana i promeni podatke. Novom stanu daj slobodan `slot` (l7, l8...).
2. Popuni i polja koja koristi pretraga: `tip`, `cenaBroj`, `m2`, `sobeBroj`, `novogradnja`.
3. Popuni polja za stranu detalja: `oglasId`, `opis` (lista pasusa) i `detalji` (parovi naziv/vrednost).
4. Ubaci slike: `slike/l7.jpg` (kartica) i `slike/l7-1.jpg`, `l7-2.jpg`, `l7-3.jpg` (detalj).
5. Uklanjanje stana: obrisi njegov blok iz `stanovi.json`.
